                ...
                <div class="col-12">
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title"><?= uiLang('filters') ?></h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="selectStatusFullPaper">
                                            <?= uiLang('status_full_paper') ?>
                                        </label>
                                        <select class="form-control" id="selectStatusFullPaper">
                                            <option value="-1"><?= uiLang('all_of_them') ?></option>
                                            <option value="0"><?= uiLang('pending') ?></option>
                                            <option value="1"><?= uiLang('rejected') ?></option>
                                            <option value="2"><?= uiLang('accepted') ?></option>
                                            <option value="3"><?= uiLang('nothing') ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="selectStatusInvoice">
                                            <?= uiLang('status_invoice') ?>
                                        </label>
                                        <select class="form-control" id="selectStatusInvoice">
                                            <option value="-1"><?= uiLang('all_of_them') ?></option>
                                            <option value="0"><?= uiLang('pending') ?></option>
                                            <option value="1"><?= uiLang('rejected') ?></option>
                                            <option value="2"><?= uiLang('accepted') ?></option>
        ...
        $('#submissions').DataTable({
            ...
            'ajax': {
                ...
                'data': function (d) {
                    ...
                    d.invoice = document.getElementById("selectStatusInvoice").value;
                },
