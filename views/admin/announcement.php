                ...
                'dataSrc': function (json) {
                    for (var i = 0; i < json.data.length; i++) {
                        ...
                        json.data[i].options = '<a class="btn btn-primary" onclick="showDetailAnnouncement(' + i + ')"><span class="fas fa-eye"></span></a>'
                            + ' <a class="btn btn-warning" onclick="showUpdateAnnouncement(' + i + ')"><span class="fas fa-edit"></span></a>'
                            + ' <a class="btn btn-danger" onclick="showDeleteAnnouncement(' + i + ')"><span class="fas fa-trash"></span></a>'; //todo
                    }
