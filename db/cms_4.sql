...
-- Üretim Zamanı: 18 Ara 2019, 14:24:27
...
--
-- Tablo için tablo yapısı `request_submission_full_paper`
--

DROP TABLE IF EXISTS `request_submission_full_paper`;
CREATE TABLE IF NOT EXISTS `request_submission_full_paper` (
...
(109, 33, 'Bb5xL1AjpbClEKRS0mg04z0oxKagt9yzqU7XbQnUwA7GYcKOnlgCmbkvHCjBoG1IX60DKhykZr4bIlKFDXswsU8Xq2EqcnLSKp4XMFaoVn9z9eRPhRgaKPl3WEvBqwnj', 'tytqswhinD8CNKDDgFndGsyDSDekS5Uff6CEfpgeG4m1ZgEG8hPmUvH8zLPGwHR4xJOVmztEf0dlLgfaV9bwTE8CebfgnPRKCwfndx9Vfnk6OZzqaFsybBnBZaumL84Q', '127.0.0.1', '2019-12-17 11:38:09', 1);
